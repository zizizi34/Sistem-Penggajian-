  ...
  <div class="col-12 col-lg-9">
    <div class="row">
      <div class="col-6 col-lg-4 col-md-6">
        <div class="card">
          <a href="{{ route('administrators.pegawai.index') }}">
      ...
      <div class="col-6 col-lg-4 col-md-6">
        <div class="card">
          <a href="{{ route('administrators.departemen.index') }}">
            <div class="card-body px-4 py-4-5">
              <div class="row">
                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
      ...
      <div class="col-6 col-lg-4 col-md-6">
        <div class="card">
          <a href="{{ route('administrators.penggajian.index') }}">
            <div class="card-body px-4 py-4-5">
              <div class="row">
                <div class="col-md-4 col-lg-12 col-xl-12 col-xxl-5 d-flex justify-content-start">
  ...
  <div class="col-12 col-lg-3">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex justify-content-between mb-3">
          <span>Tunjangan</span>
          <strong>{{ $totalTunjangan ?? 0 }}</strong>
        </div>
        <div class="d-flex justify-content-between">
          <span>Potongan</span>
          <strong>{{ $totalPotongan ?? 0 }}</strong>
        </div>
      </div>
    </div>
  </div>
