      ...
      <div class="card-body">
        <form action="{{ route('administrators.jabatan.store') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama_jabatan" class="form-control @error('nama_jabatan') is-invalid @enderror" value="{{ old('nama_jabatan') }}" required placeholder="Contoh: Senior Developer">
            @error('nama_jabatan')
          ...
          <div class="mb-3">
            ...
            @else
              <div class="alert alert-warning">Departemen belum tersedia. Silakan tambahkan departemen terlebih dahulu.</div>
            @endif
            @error('id_departemen')
              <span class="invalid-feedback">{{ $message }}</span>
            @enderror
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group">
                ...
                <input type="number" name="min_gaji" class="form-control @error('min_gaji') is-invalid @enderror" value="{{ old('min_gaji') }}" required min="0" step="1" placeholder="0">
              </div>
              @error('min_gaji')
                <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            ...
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group">
                <span class="input-group-text">Rp</span>
                <input type="number" name="max_gaji" class="form-control @error('max_gaji') is-invalid @enderror" value="{{ old('max_gaji') }}" required min="0" step="1" placeholder="0">
              </div>
              @error('max_gaji')
                <span class="invalid-feedback">{{ $message }}</span>
              @enderror
          ...
          <div class="row mt-2">
            <div class="col-md-6">
              <button type="submit" class="btn btn-primary w-100">
                <i class="bi bi-save"></i> Simpan Jabatan
              </button>
            </div>
            <div class="col-md-6">
