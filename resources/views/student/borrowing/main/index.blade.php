...
@section('title', 'Penggajian Saya Hari Ini')
@section('description', 'Halaman Daftar Penggajian Saya Hari Ini')
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="alert alert-warning" role="alert">
          ...
          Data di bawah hanya akan tampil data penggajian pada hari ini saja. Jika ingin melihat riwayat data penggajian
          yang sudah anda lakukan bisa pergi ke menu riwayat penggajian pada daftar menu.

          <div class="fw-bold pt-3">
            Diharapkan setiap penggajian yang sudah selesai mohon lakukan pengubahan data pada tombol Pengembalian.
          </div>
        </div>
