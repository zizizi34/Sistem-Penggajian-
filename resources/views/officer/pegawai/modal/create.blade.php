        ...
        <form action="{{ route('officers.pegawai.store') }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTambahPegawaiLabel"><i class="bi bi-person-plus-fill me-2"></i>Tambah Pegawai Baru</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="create_alamat" class="form-label">Alamat Lengkap <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="create_password" class="form-label">Password Akun <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" id="create_password" name="password" required placeholder="Minimal 6 karakter">
                        </div>
                    </div>

                    <h6 class="mt-4 mb-3 border-bottom pb-2 text-primary fw-bold text-uppercase small" style="letter-spacing: 0.05em;"><i class="bi bi-briefcase me-2"></i>Informasi Pekerjaan</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="create_status_pegawai" class="form-label">Status Pegawai <span class="text-danger">*</span></label>
                    ...
                    <h6 class="mt-4 mb-3 border-bottom pb-2 text-primary fw-bold text-uppercase small" style="letter-spacing: 0.05em;"><i class="bi bi-bank me-2"></i>Pajak & Rekening (Opsional)</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="create_id_ptkp_status" class="form-label text-truncate d-block">Status PTKP</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="create_npwp" class="form-label">NPWP</label>
                            <input type="text" class="form-control" id="create_npwp" name="npwp" value="{{ old('npwp') }}" placeholder="Masukkan NPWP">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="create_bank_pegawai" class="form-label">Nama Bank</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="create_no_rekening" class="form-label">No. Rekening</label>
