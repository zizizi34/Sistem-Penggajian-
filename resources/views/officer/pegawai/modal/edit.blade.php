        ...
        <form id="formEditPegawai" action="" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalEditPegawaiLabel"><i class="bi bi-pencil-square me-2"></i>Edit Data Pegawai</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="edit_password" class="form-label">Ganti Password</label>
                    ...
                    <h6 class="mt-4 mb-3 border-bottom pb-2 text-primary fw-bold text-uppercase small" style="letter-spacing: 0.05em;"><i class="bi bi-bank me-2"></i>Pajak & Rekening</h6>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="edit_id_ptkp_status" class="form-label d-block text-truncate">Status PTKP</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="edit_bank_pegawai" class="form-label">Nama Bank</label>
